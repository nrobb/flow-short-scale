...
DDATest.Menu.prototype.create = function() {
  ...
  // instructions
  this.add.bitmapText(250, 20, 'carrier-command', 'METEOR SHOWER', 15);
  ...
  // copyright
  this.add.bitmapText(250, this.world.height - 130, 'carrier-command', 'COPYRIGHT 2017 - 2018 NIGEL ROBB', 10);
